          ...
          {collectionNodes.map((node) => {
            ...
            return (
              <button
                ...
                className={`w-full p-3 rounded-lg border transition-all text-left group shadow-sm hover:shadow-md ${hasNodeOnCanvas
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`p-2 rounded-md ${hasNodeOnCanvas
                      ? `bg-${node.color}-100`
                      : `bg-${node.color}-50`
                      }`}
                  >
                    <Icon className={`w-4 h-4 ${hasNodeOnCanvas
                      ? `text-${node.color}-600`
                      : `text-${node.color}-400`
                      }`} />
                  </div>
                  <div className="flex-1">
                    <div className={`font-medium ${hasNodeOnCanvas
                      ? 'text-slate-800'
                      : 'text-slate-600'
                      }`}>
                      {node.label}
                    </div>
                    <p className={`text-xs mt-0.5 ${hasNodeOnCanvas
                      ? 'text-slate-500'
                      : 'text-slate-400'
                      }`}>
                      {node.description}
