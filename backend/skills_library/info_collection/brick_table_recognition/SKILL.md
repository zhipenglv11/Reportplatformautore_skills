---
name: brick-strength-recognition
display_name: 砖强度表格识别
description: 从砖强度检验表格（PDF/图像）中提取结构化字段，对表格类型进行分类，并输出JSON/CSV/Excel格式。
---
# Brick Strength Recognition Skill
## When to Use
Use this skill when users need to recognize brick strength inspection tables and extract structured fields from them.
